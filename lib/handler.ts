...
export const Go = (props: Props): lambda.FunctionProps => ({
  ...
  code: AssetCodeGo(props.sourceCodePackage, props.sourceCodeLambda),
  handler: 'main',
  runtime: lambda.Runtime.GO_1_X,
  functionName: `${cdk.Aws.STACK_NAME}-${path.basename([props.sourceCodePackage, props.sourceCodeLambda].join(path.sep))}`,
